...
class TestHello(unittest.TestCase):
     ...
     def test_sin(self):
         ...
         self.assertEqual(hello.sin(0.5), 0.4794255386)

     def test_cos(self):
         self.assertEqual(hello.cos(0), 1)
         self.assertEqual(hello.cos(1), 0.5403023058681398)
         self.assertEqual(hello.cos(0.5), 0.8775825619)

     def test_tan(self):
         self.assertEqual(hello.tan(0), 0)
         self.assertEqual(hello.tan(1), 1.5574077246549023)
         self.assertEqual(hello.tan(0.5), 0.5463024898)

     def test_cot(self):
         self.assertEqual(hello.cot(0), float("inf"))
         self.assertEqual(hello.cot(1), 0.6420926159343306)
         self.assertEqual(hello.cot(0.5), 0.463647609)
